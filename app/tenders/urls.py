...
from .views import PrzetargiListView, ZadanieCreateView, ZadanieUpdateView, ZadanieDetailView, SpecjalistaZadanieView
...
urlpatterns = [
    ...
    path('zadanie/<int:pk>/przypisz/', SpecjalistaZadanieView.as_view(), name='zadanie_przypisz'),
